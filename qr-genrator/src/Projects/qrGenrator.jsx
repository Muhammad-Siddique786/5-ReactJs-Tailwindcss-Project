...
const qrgenrator = () => {
    ...
    return (
        <div className=' min-h-[90vh] flex flex-col justify-center items-center bg-gradient-to-br from-gray-300 via-gray-500 to-gray-700'>
            <div>
                <h1 className='text-3xl font-bold mt-6 mb-5'>Project No.1</h1>
